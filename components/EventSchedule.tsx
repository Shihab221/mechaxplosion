...
const EventSchedule = () => {
  return (
    <div id='schedule' className='my-10 flex flex-col w-full '>
      ...
      <div className='flex flex-col sm:flex-row sm:justify-evenly w-full items-stretch'>
        <div className='bg-neutral-900 rounded-xl p-4 h-xl w-sm mb-6 px-6'>
            <h4 className='font-semibold text-xl text-lime-400 mb-4 font-orbitron mt-2'>12th June - THURSDAY</h4>
